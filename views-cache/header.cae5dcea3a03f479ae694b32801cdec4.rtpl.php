...
<head>
  ...
  <?php $description = "2M Atacado, Empresa no mercado desde 2019 com os melhores preços no mercado, com uma grande variedade de produtos, como: ferramentas, produtos para casa, alicates, torneiras, e muito mais. Estamos localizado em Cabo Frio - RJ"; ?>
  ...
  <meta name="description" content="<?php echo htmlspecialchars( $description, ENT_COMPAT, 'UTF-8', FALSE ); ?>.<?php if( $seoTags['desc'] != '' ){ ?> <?php echo htmlspecialchars( $seoTags["desc"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?>">
