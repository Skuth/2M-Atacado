          ...
          <table class="table align-items-center table-flush">
            ...
            <tbody class="text-center">
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-icon btn-primary btn-sm" href="/admin/categoria/editar/<?php echo htmlspecialchars( $value1["category_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><i class="fas fa-edit"></i></a>
                  <a class="btn btn-icon btn-danger btn-sm" onclick="return confirm('Deseja mesmo remover essa categoria?')" href="/admin/categoria/remover/<?php echo htmlspecialchars( $value1["category_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><i class="fas fa-trash"></i></a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
