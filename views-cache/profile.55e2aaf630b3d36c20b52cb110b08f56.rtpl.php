              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" disabled value="<?php if( $user["type"] == 1 ){ ?>Funcionário<?php }elseif( $user["type"] == 2 ){ ?>Administrador<?php }else{ ?>Super Administrador<?php } ?>">
                  </div>
                </div>
              </div>
              <div class="row">
