  ...
  <div class="container-fluid">
    <div class="header-body">
      ...
      <div class="row">
        ...
        <div class="col-xl-<?php echo htmlspecialchars( $col, ENT_COMPAT, 'UTF-8', FALSE ); ?> col-lg-6">
          <div class="card card-stats mb-4 mb-xl-0">
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0">Pedidos em aberto</h5>
                  <span class="h2 font-weight-bold mb-0"><?php echo htmlspecialchars( $oOpen, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
                </div>
                <div class="col-auto">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  ...
                  <span class="h2 font-weight-bold mb-0"><?php echo htmlspecialchars( $oCount, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
                </div>
                <div class="col-auto">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  ...
                  <span class="h2 font-weight-bold mb-0"><?php echo htmlspecialchars( $cCount, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
                </div>
                <div class="col-auto">
