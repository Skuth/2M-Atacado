          ...
          <table class="table align-items-center table-flush">
            ...
            <tbody class="text-center">
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-icon btn-default btn-sm" href="/admin/pedidos/visualizar/<?php echo htmlspecialchars( $value1["order_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><i class="fas fa-eye"></i></a>
                  <a class="btn btn-icon btn-primary btn-sm" href="/admin/pedidos/editar/<?php echo htmlspecialchars( $value1["order_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><i class="fas fa-edit"></i></a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
